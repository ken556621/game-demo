    ...
    <div className="bg-gradient-to-br from-red-900 to-red-800 border border-yellow-700/40 rounded-2xl p-4 shadow-lg">
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-red-950/50 rounded-xl p-3">
          <p className="text-yellow-400/70 text-xs mb-0.5">姓名</p>
          <p className="text-white font-bold truncate">{user.name}</p>
        </div>
        <div className="bg-red-950/50 rounded-xl p-3">
          <p className="text-yellow-400/70 text-xs mb-0.5">手機</p>
          <p className="text-white font-mono text-sm">{maskPhone(user.phone)}</p>
        </div>
        <div className="bg-red-950/50 rounded-xl p-3">
          <p className="text-yellow-400/70 text-xs mb-0.5">介紹成交</p>
        ...
        <div className="bg-red-950/50 rounded-xl p-3">
          <p className="text-yellow-400/70 text-xs mb-0.5">中獎機率</p>
