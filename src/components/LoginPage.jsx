...
export default function LoginPage({ onLogin }) {
  ...
  const inputClassName = 'w-full rounded-xl border-2 border-gray-200 bg-yellow-50/40 px-5 py-3.5 text-base text-gray-800 placeholder:text-gray-400 shadow-inner transition-all focus:border-yellow-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-yellow-200/70';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-900 via-red-800 to-yellow-900 px-5 py-8 sm:p-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8">
          <h2 className="text-xl font-bold text-red-800 mb-6 text-center">登入遊戲</h2>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">手機號碼</label>
              <input
                type="tel"
                value={phone}
